# Build the "Hangman" web game into an Android APK
...
Open and read **`requirement_for_web_to_apk_32-hangman.txt`** in this same folder.
...
npx cap init "Hangman" com.webgames.game32hangman --web-dir=www
...
keytool -genkey -v -keystore release.keystore -keyalg RSA -keysize 2048 \
  -validity 10000 -alias 32-hangman
```
