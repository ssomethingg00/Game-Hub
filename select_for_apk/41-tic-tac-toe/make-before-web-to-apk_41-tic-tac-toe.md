# Build the "Tic-Tac-Toe" web game into an Android APK
...
Open and read **`requirement_for_web_to_apk_41-tic-tac-toe.txt`** in this same folder.
...
npx cap init "Tic-Tac-Toe" com.webgames.game41tictactoe --web-dir=www
...
keytool -genkey -v -keystore release.keystore -keyalg RSA -keysize 2048 \
  -validity 10000 -alias 41-tic-tac-toe
```
