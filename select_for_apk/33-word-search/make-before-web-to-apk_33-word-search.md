# Build the "WordSearch" web game into an Android APK
...
Open and read **`requirement_for_web_to_apk_33-word-search.txt`** in this same folder.
...
npx cap init "WordSearch" com.webgames.game33wordsearch --web-dir=www
...
keytool -genkey -v -keystore release.keystore -keyalg RSA -keysize 2048 \
  -validity 10000 -alias 33-word-search
```
