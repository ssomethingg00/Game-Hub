# Build the "Checkers" web game into an Android APK
...
Open and read **`requirement_for_web_to_apk_43-checkers.txt`** in this same folder.
...
npx cap init "Checkers" com.webgames.game43checkers --web-dir=www
...
keytool -genkey -v -keystore release.keystore -keyalg RSA -keysize 2048 \
  -validity 10000 -alias 43-checkers
```
