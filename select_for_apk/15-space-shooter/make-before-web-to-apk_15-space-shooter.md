# Build the "Nebula Assault" web game into an Android APK
...
Open and read **`requirement_for_web_to_apk_15-space-shooter.txt`** in this same folder.
...
npx cap init "Nebula Assault" com.webgames.game15spaceshooter --web-dir=www
...
keytool -genkey -v -keystore release.keystore -keyalg RSA -keysize 2048 \
  -validity 10000 -alias 15-space-shooter
```
