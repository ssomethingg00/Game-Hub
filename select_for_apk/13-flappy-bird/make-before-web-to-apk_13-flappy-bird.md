# Build the "Sky Drifter" web game into an Android APK
...
Open and read **`requirement_for_web_to_apk_13-flappy-bird.txt`** in this same folder.
...
npx cap init "Sky Drifter" com.webgames.game13flappybird --web-dir=www
...
keytool -genkey -v -keystore release.keystore -keyalg RSA -keysize 2048 \
  -validity 10000 -alias 13-flappy-bird
```
