# Build the "Void Breaker" web game into an Android APK
...
Open and read **`requirement_for_web_to_apk_16-asteroids.txt`** in this same folder.
...
npx cap init "Void Breaker" com.webgames.game16asteroids --web-dir=www
...
keytool -genkey -v -keystore release.keystore -keyalg RSA -keysize 2048 \
  -validity 10000 -alias 16-asteroids
```
