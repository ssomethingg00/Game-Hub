# Build the "GridDrop (Block Blast)" web game into an Android APK
...
Open and read **`requirement_for_web_to_apk_29-block-blast.txt`** in this same folder.
...
npx cap init "GridDrop (Block Blast)" com.webgames.game29blockblast --web-dir=www
...
keytool -genkey -v -keystore release.keystore -keyalg RSA -keysize 2048 \
  -validity 10000 -alias 29-block-blast
```
