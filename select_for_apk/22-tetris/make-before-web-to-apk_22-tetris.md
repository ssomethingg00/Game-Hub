# Build the "BlockDrop (Tetris)" web game into an Android APK
...
Open and read **`requirement_for_web_to_apk_22-tetris.txt`** in this same folder.
...
npx cap init "BlockDrop (Tetris)" com.webgames.game22tetris --web-dir=www
...
keytool -genkey -v -keystore release.keystore -keyalg RSA -keysize 2048 \
  -validity 10000 -alias 22-tetris
```
