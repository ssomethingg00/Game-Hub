# Build the "Video Poker — Jacks or Better" web game into an Android APK
...
Open and read **`requirement_for_web_to_apk_40-video-poker.txt`** in this same folder.
...
npx cap init "Video Poker — Jacks or Better" com.webgames.game40videopoker --web-dir=www
...
keytool -genkey -v -keystore release.keystore -keyalg RSA -keysize 2048 \
  -validity 10000 -alias 40-video-poker
```
