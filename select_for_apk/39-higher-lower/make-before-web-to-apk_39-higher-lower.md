# Build the "HIGHLOW — Higher or Lower Card Game" web game into an Android APK
...
Open and read **`requirement_for_web_to_apk_39-higher-lower.txt`** in this same folder.
...
npx cap init "HIGHLOW — Higher or Lower Card Game" com.webgames.game39higherlower --web-dir=www
...
keytool -genkey -v -keystore release.keystore -keyalg RSA -keysize 2048 \
  -validity 10000 -alias 39-higher-lower
```
