# Build the "GemBlast (Match-3)" web game into an Android APK
...
Open and read **`requirement_for_web_to_apk_23-match-3.txt`** in this same folder.
...
npx cap init "GemBlast (Match-3)" com.webgames.game23match3 --web-dir=www
...
keytool -genkey -v -keystore release.keystore -keyalg RSA -keysize 2048 \
  -validity 10000 -alias 23-match-3
```
