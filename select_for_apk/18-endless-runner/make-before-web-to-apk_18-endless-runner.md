# Build the "SwiftStride" web game into an Android APK
...
Open and read **`requirement_for_web_to_apk_18-endless-runner.txt`** in this same folder.
...
npx cap init "SwiftStride" com.webgames.game18endlessrunner --web-dir=www
...
keytool -genkey -v -keystore release.keystore -keyalg RSA -keysize 2048 \
  -validity 10000 -alias 18-endless-runner
```
