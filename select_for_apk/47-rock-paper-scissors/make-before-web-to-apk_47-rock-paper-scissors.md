# Build the "Rock Paper Scissors" web game into an Android APK
...
Open and read **`requirement_for_web_to_apk_47-rock-paper-scissors.txt`** in this same folder.
...
npx cap init "Rock Paper Scissors" com.webgames.game47rockpaperscissors --web-dir=www
...
keytool -genkey -v -keystore release.keystore -keyalg RSA -keysize 2048 \
  -validity 10000 -alias 47-rock-paper-scissors
```
