# Build the "Blackjack 21" web game into an Android APK
...
Open and read **`requirement_for_web_to_apk_37-blackjack.txt`** in this same folder.
...
npx cap init "Blackjack 21" com.webgames.game37blackjack --web-dir=www
...
keytool -genkey -v -keystore release.keystore -keyalg RSA -keysize 2048 \
  -validity 10000 -alias 37-blackjack
```
