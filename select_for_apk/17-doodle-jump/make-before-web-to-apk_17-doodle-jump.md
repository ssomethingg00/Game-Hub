# Build the "Sky Hopper" web game into an Android APK
...
Open and read **`requirement_for_web_to_apk_17-doodle-jump.txt`** in this same folder.
...
npx cap init "Sky Hopper" com.webgames.game17doodlejump --web-dir=www
...
keytool -genkey -v -keystore release.keystore -keyalg RSA -keysize 2048 \
  -validity 10000 -alias 17-doodle-jump
```
