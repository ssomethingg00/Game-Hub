# Build the "Memory Match" web game into an Android APK
...
Open and read **`requirement_for_web_to_apk_27-memory-card-match.txt`** in this same folder.
...
npx cap init "Memory Match" com.webgames.game27memorycardmatch --web-dir=www
...
keytool -genkey -v -keystore release.keystore -keyalg RSA -keysize 2048 \
  -validity 10000 -alias 27-memory-card-match
```
