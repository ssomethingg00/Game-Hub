# Build the "Reflex Rush (Reaction Time Test)" web game into an Android APK
...
Open and read **`requirement_for_web_to_apk_50-reaction-test.txt`** in this same folder.
...
npx cap init "Reflex Rush (Reaction Time Test)" com.webgames.game50reactiontest --web-dir=www
...
keytool -genkey -v -keystore release.keystore -keyalg RSA -keysize 2048 \
  -validity 10000 -alias 50-reaction-test
```
