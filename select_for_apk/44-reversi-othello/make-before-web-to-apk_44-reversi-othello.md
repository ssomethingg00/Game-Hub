# Build the "Reversi" web game into an Android APK
...
Open and read **`requirement_for_web_to_apk_44-reversi-othello.txt`** in this same folder.
...
npx cap init "Reversi" com.webgames.game44reversiothello --web-dir=www
...
keytool -genkey -v -keystore release.keystore -keyalg RSA -keysize 2048 \
  -validity 10000 -alias 44-reversi-othello
```
