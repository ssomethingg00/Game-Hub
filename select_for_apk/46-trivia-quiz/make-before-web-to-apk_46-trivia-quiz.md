# Build the "Trivia Quiz" web game into an Android APK
...
Open and read **`requirement_for_web_to_apk_46-trivia-quiz.txt`** in this same folder.
...
npx cap init "Trivia Quiz" com.webgames.game46triviaquiz --web-dir=www
...
keytool -genkey -v -keystore release.keystore -keyalg RSA -keysize 2048 \
  -validity 10000 -alias 46-trivia-quiz
```
