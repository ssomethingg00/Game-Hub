# Build the "Memory Pads (Simon Says)" web game into an Android APK
...
Open and read **`requirement_for_web_to_apk_48-simon-says.txt`** in this same folder.
...
npx cap init "Memory Pads (Simon Says)" com.webgames.game48simonsays --web-dir=www
...
keytool -genkey -v -keystore release.keystore -keyalg RSA -keysize 2048 \
  -validity 10000 -alias 48-simon-says
```
