# Build the "Sudoku" web game into an Android APK
...
Open and read **`requirement_for_web_to_apk_26-sudoku.txt`** in this same folder.
...
npx cap init "Sudoku" com.webgames.game26sudoku --web-dir=www
...
keytool -genkey -v -keystore release.keystore -keyalg RSA -keysize 2048 \
  -validity 10000 -alias 26-sudoku
```
