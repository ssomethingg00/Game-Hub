# Build the "Mole Madness!" web game into an Android APK
...
Open and read **`requirement_for_web_to_apk_20-whack-a-mole.txt`** in this same folder.
...
npx cap init "Mole Madness!" com.webgames.game20whackamole --web-dir=www
...
keytool -genkey -v -keystore release.keystore -keyalg RSA -keysize 2048 \
  -validity 10000 -alias 20-whack-a-mole
```
