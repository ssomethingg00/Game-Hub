# Build the "Connect Four" web game into an Android APK
...
Open and read **`requirement_for_web_to_apk_42-connect-four.txt`** in this same folder.
...
npx cap init "Connect Four" com.webgames.game42connectfour --web-dir=www
...
keytool -genkey -v -keystore release.keystore -keyalg RSA -keysize 2048 \
  -validity 10000 -alias 42-connect-four
```
