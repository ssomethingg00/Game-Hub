# Build the "Street Hopper" web game into an Android APK
...
Open and read **`requirement_for_web_to_apk_19-road-crossing.txt`** in this same folder.
...
npx cap init "Street Hopper" com.webgames.game19roadcrossing --web-dir=www
...
keytool -genkey -v -keystore release.keystore -keyalg RSA -keysize 2048 \
  -validity 10000 -alias 19-road-crossing
```
