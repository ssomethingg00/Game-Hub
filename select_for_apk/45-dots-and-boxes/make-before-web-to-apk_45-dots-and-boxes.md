# Build the "Line & Claim (Dots and Boxes)" web game into an Android APK
...
Open and read **`requirement_for_web_to_apk_45-dots-and-boxes.txt`** in this same folder.
...
npx cap init "Line & Claim (Dots and Boxes)" com.webgames.game45dotsandboxes --web-dir=www
...
keytool -genkey -v -keystore release.keystore -keyalg RSA -keysize 2048 \
  -validity 10000 -alias 45-dots-and-boxes
```
