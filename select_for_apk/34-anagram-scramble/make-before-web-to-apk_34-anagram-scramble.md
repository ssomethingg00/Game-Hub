# Build the "WordScramble — Unscramble the Word!" web game into an Android APK
...
Open and read **`requirement_for_web_to_apk_34-anagram-scramble.txt`** in this same folder.
...
npx cap init "WordScramble — Unscramble the Word!" com.webgames.game34anagramscramble --web-dir=www
...
keytool -genkey -v -keystore release.keystore -keyalg RSA -keysize 2048 \
  -validity 10000 -alias 34-anagram-scramble
```
