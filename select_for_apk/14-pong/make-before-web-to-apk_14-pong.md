# Build the "PONG" web game into an Android APK
...
Open and read **`requirement_for_web_to_apk_14-pong.txt`** in this same folder.
...
npx cap init "PONG" com.webgames.game14pong --web-dir=www
