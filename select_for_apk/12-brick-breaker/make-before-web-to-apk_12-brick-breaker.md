# Build the "Brick Breaker" web game into an Android APK
...
Open and read **`requirement_for_web_to_apk_12-brick-breaker.txt`** in this same folder.
...
npx cap init "Brick Breaker" com.webgames.game12brickbreaker --web-dir=www
...
keytool -genkey -v -keystore release.keystore -keyalg RSA -keysize 2048 \
  -validity 10000 -alias 12-brick-breaker
```
