# Build the "Sliding Puzzle" web game into an Android APK
...
Open and read **`requirement_for_web_to_apk_25-sliding-puzzle.txt`** in this same folder.
...
npx cap init "Sliding Puzzle" com.webgames.game25slidingpuzzle --web-dir=www
...
keytool -genkey -v -keystore release.keystore -keyalg RSA -keysize 2048 \
  -validity 10000 -alias 25-sliding-puzzle
```
