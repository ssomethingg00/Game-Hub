# Build the "Tower of Hanoi" web game into an Android APK
...
Open and read **`requirement_for_web_to_apk_28-tower-of-hanoi.txt`** in this same folder.
...
npx cap init "Tower of Hanoi" com.webgames.game28towerofhanoi --web-dir=www
...
keytool -genkey -v -keystore release.keystore -keyalg RSA -keysize 2048 \
  -validity 10000 -alias 28-tower-of-hanoi
```
