# Build the "TypeSprint — Typing Speed Test" web game into an Android APK
...
Open and read **`requirement_for_web_to_apk_35-typing-speed.txt`** in this same folder.
...
npx cap init "TypeSprint — Typing Speed Test" com.webgames.game35typingspeed --web-dir=www
...
keytool -genkey -v -keystore release.keystore -keyalg RSA -keysize 2048 \
  -validity 10000 -alias 35-typing-speed
```
