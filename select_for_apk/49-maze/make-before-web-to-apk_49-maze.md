# Build the "Maze — Level Up" web game into an Android APK
...
Open and read **`requirement_for_web_to_apk_49-maze.txt`** in this same folder.
...
npx cap init "Maze — Level Up" com.webgames.game49maze --web-dir=www
