# Build the "Klondike Solitaire" web game into an Android APK
...
Open and read **`requirement_for_web_to_apk_36-solitaire-klondike.txt`** in this same folder.
...
npx cap init "Klondike Solitaire" com.webgames.game36solitaireklondike --web-dir=www
...
keytool -genkey -v -keystore release.keystore -keyalg RSA -keysize 2048 \
  -validity 10000 -alias 36-solitaire-klondike
```
