# Build the "Memory Flip — Card Concentration" web game into an Android APK
...
Open and read **`requirement_for_web_to_apk_38-memory-flip.txt`** in this same folder.
...
npx cap init "Memory Flip — Card Concentration" com.webgames.game38memoryflip --web-dir=www
...
keytool -genkey -v -keystore release.keystore -keyalg RSA -keysize 2048 \
  -validity 10000 -alias 38-memory-flip
```
