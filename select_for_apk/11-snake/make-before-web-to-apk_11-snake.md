# Build the "Pixel Serpent" web game into an Android APK
...
Open and read **`requirement_for_web_to_apk_11-snake.txt`** in this same folder.
...
npx cap init "Pixel Serpent" com.webgames.game11snake --web-dir=www
