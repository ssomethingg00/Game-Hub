# Build the "Hue Flood (Color Flood)" web game into an Android APK
...
Open and read **`requirement_for_web_to_apk_30-color-flood.txt`** in this same folder.
...
npx cap init "Hue Flood (Color Flood)" com.webgames.game30colorflood --web-dir=www
...
keytool -genkey -v -keystore release.keystore -keyalg RSA -keysize 2048 \
  -validity 10000 -alias 30-color-flood
```
