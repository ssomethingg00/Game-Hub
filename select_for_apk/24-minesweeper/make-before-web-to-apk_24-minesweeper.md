# Build the "Minesweeper" web game into an Android APK
...
Open and read **`requirement_for_web_to_apk_24-minesweeper.txt`** in this same folder.
...
npx cap init "Minesweeper" com.webgames.game24minesweeper --web-dir=www
...
keytool -genkey -v -keystore release.keystore -keyalg RSA -keysize 2048 \
  -validity 10000 -alias 24-minesweeper
```
